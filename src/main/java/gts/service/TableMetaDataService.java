...
public interface TableMetaDataService {
    ...
    Map<String, Object> updateDataByTableNameAndId(String tableName, Long id);

    void deleteDataByTableNameAndId(String tableName, Long id);

    PaginationDTO<Map<String, Object>> getDataPaginated(String tableName, Integer page, Integer size);
}
